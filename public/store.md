...
![Shadow Crawler](https://shadowcrawler.vercel.app/img/hero.png)
...
![Real-time Torch](https://shadowcrawler.vercel.app/img/torch-timer-01-real-time.png)
![Turn Count Torch](https://shadowcrawler.vercel.app/img/torch-timer-01-turn-count.png)

## Crawling Turns Counter

Keep track of the current crawling turn.

![Turn Counter](https://shadowcrawler.vercel.app/img/turn-counter.png)
...
![Dice Roller](https://shadowcrawler.vercel.app/img/random-encounter-roller.png)

## Player View

You can toggle the `Torch Timer` to be visible to the players. And they will see it as follows:

![Players Real-time Torch](https://shadowcrawler.vercel.app/img/torch-timer-02-real-time.png)
![Players Turn Count Torch](https://shadowcrawler.vercel.app/img/torch-timer-02-turn-count.png)
